...
var Tea = /** @class */ (function () {
    ...
    Tea.prototype.Encrypt8Bytes = function () {
        var _this = this;
    ...
    Tea.prototype.GetUInt = function (input, offset, len) {
        var ret = 0;
    ...
    Tea.prototype.Encipher = function (input) {
        var loop = 0x10;
    ...
    Tea.prototype.ToBytes = function (a, b) {
    ...
    Tea.prototype.Decipher = function (input, offset) {
    ...
    Tea.prototype.Decrypt8Bytes = function (input, offset, len) {
        if (offset === void 0) { offset = 0; }
        for (this.pos = 0; this.pos < 8; this.pos++) {
    ...
    Tea.prototype.Decrypt = function (input, key) {
        this.header = true;
    ...
    // 数字为16进制
    Tea.prototype.Encrypt = function (input, key) {
        var len = input.length;
