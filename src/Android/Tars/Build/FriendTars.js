...
(function (FriendTars) {
    var StUinInfo = /** @class */ (function () {
        ...
        StUinInfo._write = function (os, tag, val) { os.writeStruct(tag, val); };
        StUinInfo._read = function (is, tag, def) { return is.readStruct(tag, true, def); };
        StUinInfo._readFrom = function (is) {
            var tmp = new StUinInfo;
        ...
        StUinInfo.prototype._writeTo = function (os) {
        ...
        StUinInfo.prototype._equal = function () {
            assert.fail("this structure not define key operation");
        };
        StUinInfo.prototype._genKey = function () {
            if (!this._proto_struct_name_) {
                this._proto_struct_name_ = "STRUCT" + Math.random();
            }
            return this._proto_struct_name_;
        };
        StUinInfo.prototype.toObject = function () {
            return {
                Dwuin: this.Dwuin,
                DwFlag: this.DwFlag,
                SName: this.SName,
        ...
        StUinInfo.prototype.readFromObject = function (json) {
        ...
        StUinInfo.prototype.toBinBuffer = function () {
            var os = new TarsStream.TarsOutputStream();
            this._writeTo(os);
            return os.getBinBuffer();
        };
        StUinInfo["new"] = function () {
            return new StUinInfo();
        };
        StUinInfo.create = function (is) {
    ...
    var ModifyGroupCardReq = /** @class */ (function () {
        function ModifyGroupCardReq() {
            this.DwZero = 0;
            this.DwGroupCode = 0;
            this.DwNewSeq = 0;
        ...
        ModifyGroupCardReq._write = function (os, tag, val) { os.writeStruct(tag, val); };
        ModifyGroupCardReq._read = function (is, tag, def) { return is.readStruct(tag, true, def); };
        ModifyGroupCardReq._readFrom = function (is) {
            var tmp = new ModifyGroupCardReq;
        ...
        ModifyGroupCardReq.prototype._writeTo = function (os) {
            os.writeInt64(0, this.DwZero);
            os.writeInt64(1, this.DwGroupCode);
            os.writeInt64(2, this.DwNewSeq);
            os.writeList(3, this.VecUinInfo);
        };
        ModifyGroupCardReq.prototype._equal = function () {
            assert.fail("this structure not define key operation");
        };
        ModifyGroupCardReq.prototype._genKey = function () {
            if (!this._proto_struct_name_) {
                this._proto_struct_name_ = "STRUCT" + Math.random();
            }
            return this._proto_struct_name_;
        };
        ModifyGroupCardReq.prototype.toObject = function () {
            return {
                DwZero: this.DwZero,
        ...
        ModifyGroupCardReq.prototype.readFromObject = function (json) {
        ...
        ModifyGroupCardReq.prototype.toBinBuffer = function () {
            var os = new TarsStream.TarsOutputStream();
            this._writeTo(os);
            return os.getBinBuffer();
        };
        ModifyGroupCardReq["new"] = function () {
            return new ModifyGroupCardReq();
        };
        ModifyGroupCardReq.create = function (is) {
            return FriendTars.ModifyGroupCardReq._readFrom(is);
        };
        ModifyGroupCardReq._classname = "FriendTars.ModifyGroupCardReq";
        return ModifyGroupCardReq;
    }());
    FriendTars.ModifyGroupCardReq = ModifyGroupCardReq;
    var GetFriendListReq = /** @class */ (function () {
        function GetFriendListReq() {
            this.ReqType = 0;
            this.IfReflush = 0;
            this.Uin = 0;
            this.StartIndex = 0;
        ...
        GetFriendListReq._write = function (os, tag, val) { os.writeStruct(tag, val); };
        GetFriendListReq._read = function (is, tag, def) { return is.readStruct(tag, true, def); };
        GetFriendListReq._readFrom = function (is) {
            var tmp = new GetFriendListReq;
        ...
        GetFriendListReq.prototype._writeTo = function (os) {
        ...
        GetFriendListReq.prototype._equal = function () {
            assert.fail("this structure not define key operation");
        };
        GetFriendListReq.prototype._genKey = function () {
            if (!this._proto_struct_name_) {
                this._proto_struct_name_ = "STRUCT" + Math.random();
            }
            return this._proto_struct_name_;
        };
        GetFriendListReq.prototype.toObject = function () {
            return {
        ...
        GetFriendListReq.prototype.readFromObject = function (json) {
        ...
        GetFriendListReq.prototype.toBinBuffer = function () {
            var os = new TarsStream.TarsOutputStream();
            this._writeTo(os);
            return os.getBinBuffer();
        };
        GetFriendListReq["new"] = function () {
            return new GetFriendListReq();
        };
        GetFriendListReq.create = function (is) {
    ...
    var VipOpenInfo = /** @class */ (function () {
        function VipOpenInfo() {
            this.Open = true;
            this.IVipType = 0;
            this.IVipLevel = 0;
            this.IVipFlag = 0;
        ...
        VipOpenInfo._write = function (os, tag, val) { os.writeStruct(tag, val); };
        VipOpenInfo._read = function (is, tag, def) { return is.readStruct(tag, true, def); };
        VipOpenInfo._readFrom = function (is) {
            var tmp = new VipOpenInfo;
        ...
        VipOpenInfo.prototype._writeTo = function (os) {
        ...
        VipOpenInfo.prototype._equal = function () {
            assert.fail("this structure not define key operation");
        };
        VipOpenInfo.prototype._genKey = function () {
            if (!this._proto_struct_name_) {
                this._proto_struct_name_ = "STRUCT" + Math.random();
            }
            return this._proto_struct_name_;
        };
        VipOpenInfo.prototype.toObject = function () {
            return {
                Open: this.Open,
        ...
        VipOpenInfo.prototype.readFromObject = function (json) {
        ...
        VipOpenInfo.prototype.toBinBuffer = function () {
            var os = new TarsStream.TarsOutputStream();
            this._writeTo(os);
            return os.getBinBuffer();
        };
        VipOpenInfo["new"] = function () {
            return new VipOpenInfo();
        };
        VipOpenInfo.create = function (is) {
    ...
    var VipBaseInfo = /** @class */ (function () {
        function VipBaseInfo() {
        ...
        VipBaseInfo._write = function (os, tag, val) { os.writeStruct(tag, val); };
        VipBaseInfo._read = function (is, tag, def) { return is.readStruct(tag, true, def); };
        VipBaseInfo._readFrom = function (is) {
            var tmp = new VipBaseInfo;
        ...
        VipBaseInfo.prototype._writeTo = function (os) {
            os.writeMap(0, this.MOpenInfo);
            os.writeInt32(1, this.INameplateVipType);
            os.writeInt32(2, this.IGrayNameplateFlag);
        };
        VipBaseInfo.prototype._equal = function () {
            assert.fail("this structure not define key operation");
        };
        VipBaseInfo.prototype._genKey = function () {
            if (!this._proto_struct_name_) {
                this._proto_struct_name_ = "STRUCT" + Math.random();
            }
            return this._proto_struct_name_;
        };
        VipBaseInfo.prototype.toObject = function () {
            return {
        ...
        VipBaseInfo.prototype.readFromObject = function (json) {
        ...
        VipBaseInfo.prototype.toBinBuffer = function () {
            var os = new TarsStream.TarsOutputStream();
            this._writeTo(os);
            return os.getBinBuffer();
        };
        VipBaseInfo["new"] = function () {
            return new VipBaseInfo();
        };
        VipBaseInfo.create = function (is) {
    ...
    var FriendInfo = /** @class */ (function () {
        ...
        FriendInfo._write = function (os, tag, val) { os.writeStruct(tag, val); };
        FriendInfo._read = function (is, tag, def) { return is.readStruct(tag, true, def); };
        FriendInfo._readFrom = function (is) {
            var tmp = new FriendInfo;
        ...
        FriendInfo.prototype._writeTo = function (os) {
        ...
        FriendInfo.prototype._equal = function () {
            assert.fail("this structure not define key operation");
        };
        FriendInfo.prototype._genKey = function () {
            if (!this._proto_struct_name_) {
                this._proto_struct_name_ = "STRUCT" + Math.random();
            }
            return this._proto_struct_name_;
        };
        FriendInfo.prototype.toObject = function () {
            return {
                Uin: this.Uin,
                GroupId: this.GroupId,
                FaceId: this.FaceId,
        ...
        FriendInfo.prototype.readFromObject = function (json) {
            _hasOwnProperty.call(json, "Uin") && (this.Uin = json.Uin);
            _hasOwnProperty.call(json, "GroupId") && (this.GroupId = json.GroupId);
        ...
        FriendInfo.prototype.toBinBuffer = function () {
            var os = new TarsStream.TarsOutputStream();
            this._writeTo(os);
            return os.getBinBuffer();
        };
        FriendInfo["new"] = function () {
            return new FriendInfo();
        };
        FriendInfo.create = function (is) {
    ...
    var GroupInfo = /** @class */ (function () {
        ...
        GroupInfo._write = function (os, tag, val) { os.writeStruct(tag, val); };
        GroupInfo._read = function (is, tag, def) { return is.readStruct(tag, true, def); };
        GroupInfo._readFrom = function (is) {
        ...
        GroupInfo.prototype._writeTo = function (os) {
        ...
        GroupInfo.prototype._equal = function () {
            assert.fail("this structure not define key operation");
        };
        GroupInfo.prototype._genKey = function () {
            if (!this._proto_struct_name_) {
                this._proto_struct_name_ = "STRUCT" + Math.random();
            }
            return this._proto_struct_name_;
        };
        GroupInfo.prototype.toObject = function () {
            return {
                GroupId: this.GroupId,
        ...
        GroupInfo.prototype.readFromObject = function (json) {
            _hasOwnProperty.call(json, "GroupId") && (this.GroupId = json.GroupId);
        ...
        GroupInfo.prototype.toBinBuffer = function () {
            var os = new TarsStream.TarsOutputStream();
            this._writeTo(os);
            return os.getBinBuffer();
        };
        GroupInfo["new"] = function () {
            return new GroupInfo();
        };
        GroupInfo.create = function (is) {
    ...
    var FriendListSubSrvRspCode = /** @class */ (function () {
        function FriendListSubSrvRspCode() {
            this.WGetMutualMarkRspCode = 0;
            this.WGetIntimateInfoRspCode = 0;
            this._proto_struct_name_ = "";
            this._classname = "FriendTars.FriendListSubSrvRspCode";
        }
        FriendListSubSrvRspCode._write = function (os, tag, val) { os.writeStruct(tag, val); };
        FriendListSubSrvRspCode._read = function (is, tag, def) { return is.readStruct(tag, true, def); };
        FriendListSubSrvRspCode._readFrom = function (is) {
            var tmp = new FriendListSubSrvRspCode;
            tmp.WGetMutualMarkRspCode = is.readInt16(0, false, 0);
            tmp.WGetIntimateInfoRspCode = is.readInt16(2, false, 0);
            return tmp;
        };
        FriendListSubSrvRspCode.prototype._writeTo = function (os) {
            os.writeInt16(0, this.WGetMutualMarkRspCode);
            os.writeInt16(2, this.WGetIntimateInfoRspCode);
        };
        FriendListSubSrvRspCode.prototype._equal = function () {
            assert.fail("this structure not define key operation");
        };
        FriendListSubSrvRspCode.prototype._genKey = function () {
            if (!this._proto_struct_name_) {
                this._proto_struct_name_ = "STRUCT" + Math.random();
            }
            return this._proto_struct_name_;
        };
        FriendListSubSrvRspCode.prototype.toObject = function () {
            return {
                WGetMutualMarkRspCode: this.WGetMutualMarkRspCode,
                WGetIntimateInfoRspCode: this.WGetIntimateInfoRspCode
            };
        };
        FriendListSubSrvRspCode.prototype.readFromObject = function (json) {
        ...
        FriendListSubSrvRspCode.prototype.toBinBuffer = function () {
            var os = new TarsStream.TarsOutputStream();
            this._writeTo(os);
            return os.getBinBuffer();
        };
        FriendListSubSrvRspCode["new"] = function () {
            return new FriendListSubSrvRspCode();
        };
        FriendListSubSrvRspCode.create = function (is) {
        ...
        return FriendListSubSrvRspCode;
    }());
    FriendTars.FriendListSubSrvRspCode = FriendListSubSrvRspCode;
    var GetFriendListResp = /** @class */ (function () {
        function GetFriendListResp() {
            this.ReqType = 0;
            this.IfReflush = 0;
            this.Uin = 0;
            this.StartIndex = 0;
        ...
        GetFriendListResp._write = function (os, tag, val) { os.writeStruct(tag, val); };
        GetFriendListResp._read = function (is, tag, def) { return is.readStruct(tag, true, def); };
        GetFriendListResp._readFrom = function (is) {
            var tmp = new GetFriendListResp;
        ...
        GetFriendListResp.prototype._writeTo = function (os) {
            os.writeInt32(0, this.ReqType);
            os.writeInt8(1, this.IfReflush);
            os.writeInt64(2, this.Uin);
            os.writeInt16(3, this.StartIndex);
        ...
        GetFriendListResp.prototype._equal = function () {
            assert.fail("this structure not define key operation");
        };
        GetFriendListResp.prototype._genKey = function () {
            if (!this._proto_struct_name_) {
                this._proto_struct_name_ = "STRUCT" + Math.random();
            }
            return this._proto_struct_name_;
        };
        GetFriendListResp.prototype.toObject = function () {
            return {
                ReqType: this.ReqType,
                IfReflush: this.IfReflush,
                Uin: this.Uin,
        ...
        GetFriendListResp.prototype.readFromObject = function (json) {
            _hasOwnProperty.call(json, "ReqType") && (this.ReqType = json.ReqType);
            _hasOwnProperty.call(json, "IfReflush") && (this.IfReflush = json.IfReflush);
            _hasOwnProperty.call(json, "Uin") && (this.Uin = json.Uin);
            _hasOwnProperty.call(json, "StartIndex") && (this.StartIndex = json.StartIndex);
        ...
        GetFriendListResp.prototype.toBinBuffer = function () {
            var os = new TarsStream.TarsOutputStream();
            this._writeTo(os);
            return os.getBinBuffer();
        };
        GetFriendListResp["new"] = function () {
            return new GetFriendListResp();
        };
        GetFriendListResp.create = function (is) {
