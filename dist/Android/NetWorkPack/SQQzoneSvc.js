...
const SQQzoneSvcTars_1 = require("../Tars/Build/SQQzoneSvcTars");
class SQQzoneSvc {
    static GetUndealCount(QQ, QQBuff, Mac, Imsi) {
        let In = new stream_1.default.TarsOutputStream();
        ...
        let QMF_PROTOCALmobile_get_config_req = new stream_1.default.Map(stream_1.default.String, stream_1.default.BinBuffer);
        let QMF_PROTOCALQmfBusiControl = new stream_1.default.Map(stream_1.default.String, stream_1.default.BinBuffer);
        let Int32 = new stream_1.default.Map(stream_1.default.String, stream_1.default.BinBuffer);
        let Struct2 = SQQzoneSvcTars_1.SQQZoneSvcTars.QMF_PROTOCALmobile_get_config_req.new();
        let QMFConfigStruct = new stream_1.default.TarsOutputStream();
        let Struct = SQQzoneSvcTars_1.SQQZoneSvcTars.QMF_PROTOCALQmfBusiControl.new();
        let QMFConfig2Struct = new stream_1.default.TarsOutputStream();
        Struct.Flag = true;
        Struct.IParam = 187;
        ...
        let Map3 = new stream_1.default.Map(stream_1.default.String, stream_1.default.Map(stream_1.default.String, stream_1.default.BinBuffer));
        ...
        let Map = new stream_1.default.TarsOutputStream();
        Map.writeMap(0, Map3);
