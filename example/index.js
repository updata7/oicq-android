...
var Main_1 = __importDefault(require("../dist/Android/Main"));
var BotConfig = {
    QQ: 123456789,
    PassWord: "123456789"
};
//   1安卓平板 0安卓
var Bot = new Main_1["default"](1);
Bot.SetLoginConfig({
    Brand: "HUAWEI",
    Model: "DUK-AL20",
...
Bot.Login(BotConfig.QQ, BotConfig.PassWord).then(function (Notify) {
    switch (Notify) {
        //登录成功
        case 0:
            var WebCookies = Bot.GetCookies();
            console.log(WebCookies);
            Bot.OnRegister(function () {
                ...
                setTimeout(function () {
                    Bot.OnFriendMessage(function (Message) {
                        //消息里面包含了自己所发的消息
                    ...
                    Bot.GetGroupList(function (GroupList) {
                        var _a = GroupList[0], GroupUin = _a.GroupUin, GroupCode = _a.GroupCode;
                        console.log("获取群列表成功,群数量:", GroupList.length);
                        Bot.GetGroupMembers(GroupUin, GroupCode, function (Members) {
                            console.log("群Uin:", GroupUin, "群Code:", GroupCode, "群成员数量:", Members.length);
                            /*  console.log(Members)*/
                        });
                        /*     console.log(GroupList)*/
                    });
                    Bot.GetFirendList(function (FirendList) {
                        console.log("获取好友列表成功 好友数量:", FirendList.length);
                        /*  console.log(FirendList)*/
                    });
                    Bot.OnGroupMessage(function (Message) {
                        console.log("有群消息");
                        /*          console.log(Message)*/
                    });
                }, 2000);
